...
public class BlockAlchemenisizer extends BlockContainer
{
	private static final String blockName = "alchemenisizer";
    ...
    {
        this.blockIcon = icon.registerIcon(ModInfo.MODID + ":" + "alchemenisizer_icon");
    }
