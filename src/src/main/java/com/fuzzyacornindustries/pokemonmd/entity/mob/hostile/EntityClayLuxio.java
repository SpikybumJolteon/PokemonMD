...
public class EntityClayLuxio extends EntityHostilePokemonMD implements IAnimatedEntity
{
	...
	static String mobName = "clayluxio";
	...
	public boolean attackEntityAsMob(Entity attackTarget)
	{
		...
		{
			((EntityLivingBase)attackTarget).addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, b0 * 20, 0));
		}
