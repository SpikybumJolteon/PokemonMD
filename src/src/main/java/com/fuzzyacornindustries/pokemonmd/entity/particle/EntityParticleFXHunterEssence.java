...
public class EntityParticleFXHunterEssence extends EntityFX
{
	private float essenceScale;

	private int currentTextureNumber = 0;

	public EntityParticleFXHunterEssence(World worldPar, double positionX, double positionY, double positionZ, double startingMotionX, double startingMotionY, double startingMotionZ)
	{
		...
		this.essenceScale = (this.rand.nextFloat() * 0.5F + 0.5F) * 0.5F;
	...
	public void renderParticle(Tessellator tessellatorPar, float p_70539_2_, float p_70539_3_, float p_70539_4_, float p_70539_5_, float p_70539_6_, float p_70539_7_)
	{
		...
		this.particleScale = this.essenceScale * (1.0F - f6 * f6 * 0.5F);
	...
	public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
	{
		...
		if (par1NBTTagCompound.hasKey("HunterEssenceTexture", 99))
		{
			byte b0 = par1NBTTagCompound.getByte("HunterEssenceTexture");
	...
	public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
	{
		...
		par1NBTTagCompound.setByte("HunterEssenceTexture", (byte)this.getCurrentTexture());
	}
