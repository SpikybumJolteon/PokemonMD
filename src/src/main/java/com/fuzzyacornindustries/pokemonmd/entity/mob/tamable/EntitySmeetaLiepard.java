...
import com.fuzzyacornindustries.pokemonmd.entity.mob.ai.AISmeetaLiepardPounce;
...
public class EntitySmeetaLiepard extends TamablePokemon implements IRangedAttackMob
{
	...
	static String mobName = "smeetaliepard";
	...
	public EntitySmeetaLiepard(World par1World)
	{
		super(par1World);

		this.setSize(0.5F, 0.95F);
		this.tasks.addTask(1, new EntityAISwimming(this));
		this.tasks.addTask(2, new AISmeetaLiepardPounce(this, 0.6F, 0.7F));
	...
	public void setDead()
	{
		if (this.getOwner() != null && this.getOwner() instanceof EntityPlayer && !worldObj.isRemote)
		{
			...
			ItemStack poketamableStack = new ItemSmeetaLiepardSummon().fromPoketamableEntity(this);
	...
	public void onUpdate()
	{
		...
		if(animationID != LibrarySmeetaLiepardAttackID.NO_ACTION) animationTick++;
	...
	{
		if(animationID == LibrarySmeetaLiepardAttackID.NO_ACTION)
		{
			PacketDispatcher.sendAnimationPacket(this, LibrarySmeetaLiepardAttackID.POUNCE);
		}
	}
