...
public class EntityParticleFXNormalFlame extends EntityFX
{
	private float flameScale;

	private int currentTextureNumber = 0;

	public EntityParticleFXNormalFlame(World worldPar, double positionX, double positionY, double positionZ, double startingMotionX, double startingMotionY, double startingMotionZ)
	{
