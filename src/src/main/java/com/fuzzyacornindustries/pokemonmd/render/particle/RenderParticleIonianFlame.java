...
public class RenderParticleIonianFlame extends Render
{
	private static final ResourceLocation particleTextures = new ResourceLocation(ModInfo.MODID + ":" + "textures/particles/ionianflame/ionianflame1.png");
	
    public RenderParticleIonianFlame()
    {
        this.shadowSize = 0F;
        this.shadowOpaque = 0F;
    }

    public void doRender(EntityParticleFXIonianFlame particleEntity, double parX, double parY, double parZ, float p_76986_8_, float partialTickTime)
    {
        GL11.glPushMatrix();
    ...
    protected ResourceLocation getEntityTexture(EntityParticleFXIonianFlame particleEntity)
    {
		int textureNumber = particleEntity.getCurrentTexture();

		return new ResourceLocation(ModInfo.MODID + ":" + "textures/particles/ionianflame/ionianflame" + textureNumber + ".png");
    }

    protected ResourceLocation getEntityTexture(Entity particleEntity)
    {
        return this.getEntityTexture((EntityParticleFXIonianFlame)particleEntity);
    }

    public void doRender(Entity particleEntity, double parX, double parY, double parZ, float p_76986_8_, float partialTickTime)
    {
        this.doRender((EntityParticleFXIonianFlame)particleEntity, parX, parY, parZ, p_76986_8_, partialTickTime);
    }
}