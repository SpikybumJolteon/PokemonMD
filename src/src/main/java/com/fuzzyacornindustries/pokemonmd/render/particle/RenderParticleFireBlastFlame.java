...
public class RenderParticleFireBlastFlame extends Render
{
	private static final ResourceLocation particleTextures = new ResourceLocation(ModInfo.MODID + ":" + "textures/particles/fireBlastParticle.png");
	
    public RenderParticleFireBlastFlame()
    {
        this.shadowSize = 0F;
        this.shadowOpaque = 0F;
    }

    public void doRender(EntityParticleFXBloodmoonFireBlast particleEntity, double parX, double parY, double parZ, float p_76986_8_, float partialTickTime)
    {
        GL11.glPushMatrix();
    ...
    protected ResourceLocation getEntityTexture(EntityParticleFXBloodmoonFireBlast particleEntity)
    {
    ...
    {
        return this.getEntityTexture((EntityParticleFXBloodmoonFireBlast)particleEntity);
    }

    public void doRender(Entity particleEntity, double parX, double parY, double parZ, float p_76986_8_, float partialTickTime)
    {
        this.doRender((EntityParticleFXBloodmoonFireBlast)particleEntity, parX, parY, parZ, p_76986_8_, partialTickTime);
    }
}