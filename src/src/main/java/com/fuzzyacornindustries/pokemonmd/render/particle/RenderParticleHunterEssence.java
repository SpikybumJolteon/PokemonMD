...
public class RenderParticleHunterEssence extends Render
{
	private static final ResourceLocation particleTextures = new ResourceLocation(ModInfo.MODID + ":" + "textures/particles/hunteressence/hunteressence0.png");
	
    public RenderParticleHunterEssence()
    {
        this.shadowSize = 0F;
        this.shadowOpaque = 0F;
    }

    public void doRender(EntityParticleFXHunterEssence particleEntity, double parX, double parY, double parZ, float p_76986_8_, float partialTickTime)
    {
        GL11.glPushMatrix();
    ...
    protected ResourceLocation getEntityTexture(EntityParticleFXHunterEssence particleEntity)
    {
		int textureNumber = particleEntity.getCurrentTexture();

		return new ResourceLocation(ModInfo.MODID + ":" + "textures/particles/hunteressence/hunteressence" + textureNumber + ".png");
    }

    protected ResourceLocation getEntityTexture(Entity particleEntity)
    {
        return this.getEntityTexture((EntityParticleFXHunterEssence)particleEntity);
    }

    public void doRender(Entity particleEntity, double parX, double parY, double parZ, float p_76986_8_, float partialTickTime)
    {
        this.doRender((EntityParticleFXHunterEssence)particleEntity, parX, parY, parZ, p_76986_8_, partialTickTime);
    }
}