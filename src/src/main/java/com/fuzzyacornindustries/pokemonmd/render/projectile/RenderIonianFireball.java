...
public class RenderIonianFireball extends Render
{
    ...
    public RenderIonianFireball()
    {
        this.shadowSize = 0F;
        this.shadowOpaque = 0F;
    }

    public void doRender(EntityIonianFireball particleEntity, double parX, double parY, double parZ, float p_76986_8_, float partialTickTime)
    {
        GL11.glPushMatrix();
    ...
    protected ResourceLocation getEntityTexture(EntityIonianFireball particleEntity)
    {
    ...
    {
        return this.getEntityTexture((EntityIonianFireball)particleEntity);
    }

    public void doRender(Entity particleEntity, double parX, double parY, double parZ, float p_76986_8_, float partialTickTime)
    {
        this.doRender((EntityIonianFireball)particleEntity, parX, parY, parZ, p_76986_8_, partialTickTime);
    }
}