...
public class ItemFireCapacitor extends TurretPowerItem
{
	public static String itemName = "firecapacitor";

	public ItemFireCapacitor()
	{
    ...
    public void addInformation(ItemStack itemStack, EntityPlayer player, List parList, boolean parBoolean) 
	{
		...
		parList.add("sets target on fire for 5 seconds.");
	}
