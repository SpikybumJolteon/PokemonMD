...
public class ItemBioraCapacitor extends TurretPowerItem
{
	public static String itemName = "bioracapacitor";

	public ItemBioraCapacitor()
	{
    ...
    public void addInformation(ItemStack itemStack, EntityPlayer player, List parList, boolean parBoolean) 
	{
		...
		parList.add("inflicts poison for 10 seconds.");
	}
