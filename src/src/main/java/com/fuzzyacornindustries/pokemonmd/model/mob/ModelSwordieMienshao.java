...
public class ModelSwordieMienshao extends ModelBase 
{
	...
	public void animateBody(EntitySwordieMienshao entity, float distanceMoved, float horzVelocity, float yawRotationDifference, float yawHeadOffsetDifference, float pitchRotation, float modelSize, float idleDampener)
	{
		...
		bodyLowerJointInfo.setNewRotateX(bodyLowerJointInfo.getNewRotateX() + PartAnimate.posCosRotateAnimationAdjusted(distanceMoved, horzVelocity, frequency, amplitude * 0.15F));
		bodyUpperJointInfo.setNewRotateX(bodyUpperJointInfo.getNewRotateX() + PartAnimate.posCosRotateAnimationAdjusted(distanceMoved, horzVelocity, frequency, amplitude * 0.15F));
		...
		armLftArmJointInfo.setNewRotateZ(armLftArmJointInfo.getNewRotateZ() + PartAnimate.negCosRotateAnimationAdjusted(distanceMoved, horzVelocity, frequency, amplitude) + angleChangeZ);
		armRtArmJointInfo.setNewRotateZ(armRtArmJointInfo.getNewRotateZ() + PartAnimate.negCosRotateAnimationAdjusted(distanceMoved, horzVelocity, frequency, amplitude) - angleChangeZ);

		armLftForearmJointInfo.setNewRotateZ(armLftForearmJointInfo.getNewRotateZ() + PartAnimate.negCosRotateAnimationAdjusted(distanceMoved, horzVelocity, frequency, amplitude * 2F) + angleChangeZ * 1.5F);
		armRtForearmJointInfo.setNewRotateZ(armRtForearmJointInfo.getNewRotateZ() + PartAnimate.negCosRotateAnimationAdjusted(distanceMoved, horzVelocity, frequency, amplitude * 2F) - angleChangeZ * 1.5F);
	}
