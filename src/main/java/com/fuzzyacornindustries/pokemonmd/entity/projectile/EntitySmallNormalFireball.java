...
public class EntitySmallNormalFireball extends PokemonMDFireball
{
	private int currentTextureNumber = 0;

	public EntitySmallNormalFireball(World worldPar)
	{
		super(worldPar);
	...
	public EntitySmallNormalFireball(World worldPar, double p_i1760_2_, double p_i1760_4_, double p_i1760_6_, double p_i1760_8_, double p_i1760_10_, double p_i1760_12_, float fireballSpeedModifier)
	{
	...
	public EntitySmallNormalFireball(World worldPar, EntityLivingBase shootingEntity, double p_i1761_3_, double p_i1761_5_, double p_i1761_7_, float fireballSpeedModifier)
	{
	...
	public EntitySmallNormalFireball(World worldPar, EntityLivingBase shootingEntity, double setLocationX, double setLocationY, double setLocationZ,
	...
	public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
	{
		...
		if (par1NBTTagCompound.hasKey("NormalFlameTexture", 99))
		{
			byte b0 = par1NBTTagCompound.getByte("NormalFlameTexture");
	...
	public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
	{
		...
		par1NBTTagCompound.setByte("NormalFlameTexture", (byte)this.getCurrentTexture());
	}
	...
	{
		if (!this.worldObj.isRemote && !(parMovingObjectPosition.entityHit instanceof EntitySmallNormalFireball))
		{

			if (parMovingObjectPosition.entityHit != null)
			{
				if(!parMovingObjectPosition.entityHit.isImmuneToFire())
				{
					if (parMovingObjectPosition.entityHit.attackEntityFrom(DamageSource.causeMobDamage(this.shootingEntity), 1.0F))
					{
