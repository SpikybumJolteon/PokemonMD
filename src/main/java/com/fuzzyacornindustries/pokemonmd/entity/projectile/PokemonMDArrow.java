...
public class PokemonMDArrow extends EntityArrow implements IProjectile, IEntityAdditionalSpawnData
{
	...
	/*
    public PokemonMDArrow(World p_i1754_1_, double p_i1754_2_, double p_i1754_4_, double p_i1754_6_)
    {
        super(p_i1754_1_);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public PokemonMDArrow(World p_i1755_1_, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_)
    {
        super(p_i1755_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public PokemonMDArrow(World p_i1756_1_, EntityLivingBase p_i1756_2_, float p_i1756_3_)
    {
        super(p_i1756_1_);
        this.renderDistanceWeight = 10.0D;
	...
	public PokemonMDArrow(World world, Entity entityLivingBasePar, double posX, double posY, double posZ, double motionX, double motionY, double motionZ, float rotationYaw, float rotationPitch, double damagePower)
	{
		super(world);
		this.renderDistanceWeight = 10.0D;
        ...
        yMotion /= (double)f2;
        zMotion /= (double)f2;
        xMotion += this.rand.nextGaussian() * (double)(this.rand.nextBoolean() ? -1 : 1) * 0.007499999832361937D * (double)p_70186_8_;
        yMotion += this.rand.nextGaussian() * (double)(this.rand.nextBoolean() ? -1 : 1) * 0.007499999832361937D * (double)p_70186_8_;
        zMotion += this.rand.nextGaussian() * (double)(this.rand.nextBoolean() ? -1 : 1) * 0.007499999832361937D * (double)p_70186_8_;
        xMotion *= (double)pullStrength;
        yMotion *= (double)pullStrength;
        zMotion *= (double)pullStrength;
