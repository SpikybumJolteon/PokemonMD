...
public class PokemonMDFireball extends Entity
{
    ...
    public PokemonMDFireball(World worldPar)
    {
        super(worldPar);
    ...
    public PokemonMDFireball(World p_i1760_1_, double p_i1760_2_, double p_i1760_4_, double p_i1760_6_, double p_i1760_8_, double p_i1760_10_, double p_i1760_12_, float fireballSpeedModifier)
    {
        super(p_i1760_1_);
        this.setSize(0.3125F, 0.3125F);
    ...
    public PokemonMDFireball(World p_i1761_1_, EntityLivingBase p_i1761_2_, double p_i1761_3_, double p_i1761_5_, double p_i1761_7_, float fireballSpeedModifier)
    {
        super(p_i1761_1_);
        ...
        //p_i1761_3_ += this.rand.nextGaussian() * 0.1D;
        //p_i1761_5_ += this.rand.nextGaussian() * 0.1D;
        //p_i1761_7_ += this.rand.nextGaussian() * 0.1D;
    ...
    public PokemonMDFireball(World worldPar, EntityLivingBase shootingEntity, double setLocationX, double setLocationY, double setLocationZ,
    		double accelerationXPar, double accelerationYPar, double accelerationZPar, float fireballSpeedModifier)
    {
        ...
        this.yOffset = 0.0F;
        this.motionX = this.motionY = this.motionZ = 0.0D;
        //accelerationXPar += this.rand.nextGaussian() * 0.1D;
        //accelerationYPar += this.rand.nextGaussian() * 0.1D;
        //accelerationZPar += this.rand.nextGaussian() * 0.1D;
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            float f2 = this.getMotionFactor() * fireballSpeedModifier;
	...
	protected void onImpact(MovingObjectPosition p_70227_1_)
	{
		if (!this.worldObj.isRemote)
		{
			...
			{
				if (!p_70227_1_.entityHit.isImmuneToFire() && p_70227_1_.entityHit.attackEntityFrom(DamageSource.causeMobDamage(this.shootingEntity), 5.0F))
				{
