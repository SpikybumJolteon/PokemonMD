...
import com.fuzzyacornindustries.pokemonmd.item.IWeapon;
import com.fuzzyacornindustries.pokemonmd.item.WeaponRegistry;
...
public class PlayerUtility
{
	...
	public static boolean isBlocking(EntityPlayer player) 
	{
		...
		else if (PokemonMDMain.isBG2Enabled) 
		{
			return false;//((IBattlePlayer) player).isBattlemode() && ((IBattlePlayer) player).isBlockingWithShield();
		}
		return false;
	}
	...
	public static boolean isShield(ItemStack stack) 
	{
		...
		else if (PokemonMDMain.isBG2Enabled)// && stack.getItem() instanceof IShield) 
		{
			return true;
		}
