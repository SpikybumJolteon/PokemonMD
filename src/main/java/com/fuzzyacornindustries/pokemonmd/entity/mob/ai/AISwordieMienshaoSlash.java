...
public class AISwordieMienshaoSlash extends AIAnimation 
{
	...
	{	
		if(attackTarget != null)
		{
			...
			if(entitySwordieMienshao.getAnimationTick() == 8 && attackTarget != null && entitySwordieMienshao.getDistanceSq(this.attackTarget.posX, this.attackTarget.boundingBox.minY, this.attackTarget.posZ) <= 10F)
			{
