...
public class EntityArmoredLuxray extends EntityHostilePokemonMD implements IAnimatedEntity, IMiniBoss, IStunImmune
{
	...
	static String mobName = "armoredluxray";
	...
	public boolean attackEntityAsMob(Entity targetEntity)
	{
		...
		int i = (int)targetEntity.posX;
		int j = (int)targetEntity.posY;
		int k = (int)targetEntity.posZ;

		this.worldObj.addWeatherEffect((new EntityLightningBolt(this.worldObj, i , j , k)));
	...
	protected void dropRareDrop(int par1)
	{
		...
		this.dropItem(Items.iron_ingot, 1);
		this.dropItem(Items.glowstone_dust, 4);
