...
public class RenderParticleNormalFlame extends Render
{
	private static final ResourceLocation particleTextures = new ResourceLocation(ModInfo.MODID + ":" + "textures/particles/normalflame/normalflame1.png");
	
    public RenderParticleNormalFlame()
    {
        this.shadowSize = 0F;
        this.shadowOpaque = 0F;
    }

    public void doRender(EntityParticleFXNormalFlame particleEntity, double parX, double parY, double parZ, float p_76986_8_, float partialTickTime)
    {
        GL11.glPushMatrix();
    ...
    protected ResourceLocation getEntityTexture(EntityParticleFXNormalFlame particleEntity)
    {
    ...
    {
        return this.getEntityTexture((EntityParticleFXNormalFlame)particleEntity);
    }

    public void doRender(Entity particleEntity, double parX, double parY, double parZ, float p_76986_8_, float partialTickTime)
    {
        this.doRender((EntityParticleFXNormalFlame)particleEntity, parX, parY, parZ, p_76986_8_, partialTickTime);
    }
}