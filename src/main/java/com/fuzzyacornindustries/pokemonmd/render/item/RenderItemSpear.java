...
/*
 * Taken from Battlegear's SpearRender.class
 */
public class RenderItemSpear implements IItemRenderer 
{
    ...
    {
        return item!=null && item.getItem() instanceof ItemSilkscreenSpear && (type == ItemRenderType.INVENTORY || type == ItemRenderType.EQUIPPED || type == ItemRenderType.EQUIPPED_FIRST_PERSON);
    }
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) 
    {
        ...
        if (type == ItemRenderType.EQUIPPED || type == ItemRenderType.EQUIPPED_FIRST_PERSON) 
        {
            ...
            if(type == ItemRenderType.EQUIPPED) 
            {
                ...
                GL11.glScalef(2, 2, 1);
                icon = ((ItemSilkscreenSpear) item.getItem()).bigIcon;
            }
