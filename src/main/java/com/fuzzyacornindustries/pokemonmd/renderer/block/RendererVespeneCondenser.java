...
{
	private static final ResourceLocation texture = new ResourceLocation(ModInfo.MODID + ":" +"textures/blocks/vespenecondenser.png");
	private static final ResourceLocation textureGlow = new ResourceLocation(ModInfo.MODID + ":" +"textures/blocks/vespenecondenserglows.png");
