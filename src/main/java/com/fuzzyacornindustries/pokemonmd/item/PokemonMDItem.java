...
import com.fuzzyacornindustries.pokemonmd.item.battlegear.ItemSilkscreenDagger;
import com.fuzzyacornindustries.pokemonmd.item.battlegear.ItemSilkscreenMace;
import com.fuzzyacornindustries.pokemonmd.item.battlegear.ItemSilkscreenSpear;
import com.fuzzyacornindustries.pokemonmd.item.battlegear.ItemSilkscreenWaraxe;
import com.fuzzyacornindustries.pokemonmd.item.battlegear.ItemSpiderkissDagger;
import com.fuzzyacornindustries.pokemonmd.item.battlegear.ItemSpiderkissMace;
import com.fuzzyacornindustries.pokemonmd.item.battlegear.ItemSpiderkissSpear;
import com.fuzzyacornindustries.pokemonmd.item.battlegear.ItemSpiderkissWaraxe;
...
import com.fuzzyacornindustries.pokemonmd.render.item.RenderItemSpear;
...
public class PokemonMDItem
{
	...
	public static void initializeItem()
	{
		...
		{
			silkscreenDagger = new ItemSilkscreenDagger();
			silkscreenMace = new ItemSilkscreenMace();
			silkscreenSpear = new ItemSilkscreenSpear();
			silkscreenWaraxe = new ItemSilkscreenWaraxe();
			spiderkissDagger = new ItemSpiderkissDagger();
			spiderkissMace = new ItemSpiderkissMace();
			spiderkissSpear = new ItemSpiderkissSpear();
			spiderkissWaraxe = new ItemSpiderkissWaraxe();
		}
	...
	public static void registerRenderers() 
	{
		...
		if(PokemonMDMain.isBG2Enabled)
		{
			MinecraftForgeClient.registerItemRenderer(PokemonMDItem.silkscreenSpear, new RenderItemSpear());
			MinecraftForgeClient.registerItemRenderer(PokemonMDItem.spiderkissSpear, new RenderItemSpear());
		}
	}
