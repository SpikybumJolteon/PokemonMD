...
public class ItemFiragaCapacitor extends TurretPowerItem
{
	public static String itemName = "firagacapacitor";

	public ItemFiragaCapacitor()
	{
	...
	{
		parList.add("Stage 3 attack add-on to turrets that sets target");
		parList.add("on fire for 10 seconds and deals 1+ damage.");
	}
	
	@Override
	public float getAttackPower()
	{
		return EntityPrototurret.baseAttackPower + 1.0F;
	}
