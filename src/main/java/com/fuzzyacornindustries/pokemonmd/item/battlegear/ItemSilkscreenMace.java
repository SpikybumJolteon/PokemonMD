...
public class ItemSilkscreenMace extends ItemSword implements IPotionEffect, IBattlegearWeapon, Attributes
{
	public static String itemName = "silkscreenmace";
    ...
    {
        super.addInformation(par1ItemStack, par2EntityPlayer, parList, par4);

		parList.add("A mace made of a silk material");
