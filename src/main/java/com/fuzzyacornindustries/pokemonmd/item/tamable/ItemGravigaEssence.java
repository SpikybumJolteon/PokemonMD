...
public class ItemGravigaEssence extends Item implements IEssenceItem
{
	public static String itemName = "gravigaessence";

	public ItemGravigaEssence()
	{
    ...
    public void addInformation(ItemStack itemStack, EntityPlayer player, List parList, boolean parBoolean) 
	{
		...
		parList.add("fall damage immunity.");
	}
}