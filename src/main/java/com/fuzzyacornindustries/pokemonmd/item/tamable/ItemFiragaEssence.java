...
public class ItemFiragaEssence extends Item implements IEssenceItem
{
	public static String itemName = "firagaessence";

	public ItemFiragaEssence()
	{
