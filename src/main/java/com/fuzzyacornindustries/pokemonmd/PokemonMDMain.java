...
import com.fuzzyacornindustries.pokemonmd.handler.GalacticraftEvents;
import com.fuzzyacornindustries.pokemonmd.handler.PokemonMDEntityEvents;
import com.fuzzyacornindustries.pokemonmd.handler.ZeldaSwordSkillsEvents;
...
@Mod(modid = ModInfo.MODID, name = ModInfo.name, version = ModInfo.version, dependencies = "required-after:GalacticraftCore; required-after:GalacticraftMars; required-after:battlegear2;")
public class PokemonMDMain
{
	...
	public void postInit(FMLPostInitializationEvent PostEvent)
	{
		...
		if (isZeldaSwordSkillsEnabled) 
		{
			MinecraftForge.EVENT_BUS.register(new ZeldaSwordSkillsEvents());
		}
